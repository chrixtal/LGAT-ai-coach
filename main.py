...
def sync_user_to_base44(line_user_id, display_name, coach_tone, coach_style, quote_freq, total_messages=None):
    """同步用戶資料到 Base44"""
    try:
        data = {
            'line_user_id': line_user_id,
